        ...
        "passenger": [
          ...
          },
          {
            "airline": {
              "country": "Taiwan",
              "established": 1989,
              "head_quaters": "376, Hsn-Nan Rd., Sec. 1, Luzhu, Taoyuan City, Taiwan",
              "id": 5,
              "logo": "https://upload.wikimedia.org/wikipedia/en/thumb/e/ed/EVA_Air_logo.svg/250px-EVA_Air_logo.svg.png",
              "name": "Eva Air",
              "slogan": "Sharing the World, Flying Together",
...
function Tripcount(){
var trip=JSON.stringify(pass);

var ftrip=JSON.parse(trip)



var arr=ftrip.passengers.data.passenger;

var tripcount=0
arr.forEach(element => {
    tripcount=tripcount+element.trips;
});

console.log("Total No of Trips: "+tripcount);
}
